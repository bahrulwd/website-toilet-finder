...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="/" class="nav-underline text-slate-600 hover:text-indigo-600 font-medium text-sm smooth-transition px-2 py-1">Home</a>
                    <a href="{{ route('findtoilet')}}" class="nav-underline text-slate-600 hover:text-indigo-600 font-medium text-sm smooth-transition px-2 py-1">Find Toilets</a>
                    <a href="{{ route('submit') }}" class="nav-underline text-slate-600 hover:text-indigo-600 font-medium text-sm smooth-transition px-2 py-1">Submit Toilet</a>
                    <a href="{{ route('about') }}" class="nav-underline text-indigo-600 font-semibold text-sm smooth-transition px-2 py-1">About</a>
                </div>
    ...
    <div class="md:hidden glass-card fixed inset-x-0 top-16 z-40 shadow-lg hidden smooth-transition" id="mobile-menu">
        <div class="px-2 pt-2 pb-4 space-y-2">
            ...
            <a href="#" class="block px-4 py-3 rounded-lg text-base font-medium text-slate-700 hover:bg-slate-50/50 smooth-transition">Find Toilets</a>
            ...
            <a href="{{ route('about') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-indigo-600 bg-indigo-50/50 hover:bg-indigo-100/50 smooth-transition">About</a>
            <a href="{{ route('signin') }}" class="block px-4 py-3 rounded-lg text-base font-medium text-indigo-600 hover:bg-indigo-50/50 smooth-transition border border-indigo-100 mt-2">
                Sign Up
            </a>
        </div>
    </div>
