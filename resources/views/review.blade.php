...
<body class="antialiased text-slate-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="{{ url('/') }}" class="nav-underline text-slate-600 hover:text-indigo-600 text-sm font-medium">Home</a>
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('login') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1 rounded-md text-sm font-medium shadow-sm transition-colors">
                        Sign In
                    </a>
    ...
    <div class="md:hidden glass-card fixed inset-x-0 top-16 z-40 shadow-lg hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-4 space-y-2">
            ...
            <a href="#" class="block px-4 py-3 rounded-lg text-base font-medium text-slate-700 hover:bg-slate-50/50">About</a>
    ...
    <main class="max-w-2xl mx-auto py-6 px-4 sm:px-6 relative z-10 pt-20">
        ...
        <div class="glass-card rounded-xl p-6 mb-6 hover:shadow-md transition-all">
            <h2 class="text-xl sm:text-2xl font-semibold text-slate-800 mb-2">{{ $toilet->name }}</h2>
        ...
        <div class="glass-card rounded-xl p-6 mb-6">
                    ...
                    @foreach($reviews as $review)
                        <div class="border-b border-slate-100 pb-5 last:border-0 last:pb-0">
                            <div class="flex items-center mb-2">
                                ...
                                <!-- Tambahkan rating bintang di sini -->
                            ...
                            <div class="text-slate-600 text-sm pl-11">{{ $review->content }}</div>
                        </div>
                    @endforeach
                </div>
            @else
            ...
            <form method="POST" action="{{ route('toilet.review.store', $toilet->id) }}" class="review-form mt-8">
                ...
                <textarea name="content" rows="3" 
                    class="w-full rounded-lg p-3 text-sm focus:outline-none"
                    placeholder="Share your experience with this toilet..."></textarea>
                <button type="submit" 
